...
export const supportBankCards = resource('bank_cards/support_cards', {}, {}, { _showLoadingStatus: true, ...commonOpts }) // 可用银行卡列表
...
export const repaymentError = resource('repayment/reason', {}, {}, { _showLoadingStatus: true, ...commonOpts }) // 还款失败具体错误信息
