...
// 删除base中的图片和字体的loader设置, 都去掉hash值好做好热更新准备
...
if (config.appDev.productionGzip) {
  ...
  webpackConfig.plugins.push(
    new CompressionWebpackPlugin({
      ...
      test: new RegExp(
        '\\.(' +
        config.appDev.productionGzipExtensions.join('|') +
        ')$'
      ),
      threshold: 10240,
      minRatio: 0.8
...
if (config.appDev.bundleAnalyzerReport) {
